<header class="w-100 d-flex header">
    <div class="col-2 py-1 px-4 d-flex align-items-center">
        <a href="{{ route('dashboard.index') }}" style="text-decoration: none">
            <img src="{{ asset('images/logo.png') }}" alt="logo" class="logo">
            <span class="bold fantasy color-black">Book store</span>
        </a>
    </div>
    <div class="col-10 py-1 px-4 d-flex justify-content-end align-items-center">
        <button type="button" class="btn ms-2 btn-header">
            <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-brightness-low-fill" viewBox="0 0 16 16">
